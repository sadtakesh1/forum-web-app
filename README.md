...
<img src="./client/src/assets/demo.gif" alt="Demo проекта" width="600">

> ⚠️ Обратите внимание: при первом заходе сервер может быть «в спящем» режиме (из-за хостинга сервиса render).  
> В таких случаях страница может загружаться **до ~ 1 минуты** перед тем, как отображается весь контент.  
> После этого запуск — как ожидается — мгновенный.
